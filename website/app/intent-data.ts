...
export const previewPage: IntentPageData = {
  ...
  image: "/images/tabshow-2.1-01-live-preview.png",
  imageAlt: "TabShow 2.1 side panel with a live current-window tab preview highlighted in amber",
...
export const lostTabPage: IntentPageData = {
  ...
  image: "/images/tabshow-2.1-02-search-150-tabs.png",
  imageAlt: "TabShow 2.1 search filtering 150 open Chrome tabs by title, URL, and domain",
...
export const oneTabPage: IntentPageData = {
  ...
  image: "/images/tabshow-2.1-03-keyboard-navigation.png",
  imageAlt: "TabShow 2.1 keyboard workflow using Arrow keys to select a tab and Enter to open it",
...
export const workonaPage: IntentPageData = {
  ...
  image: "/images/tabshow-2.1-04-all-windows.png",
  imageAlt: "TabShow 2.1 All windows scope showing open tabs across four Chrome windows",
...
export const tabManagerPlusPage: IntentPageData = {
  ...
  image: "/images/tabshow-2.1-05-tab-chaos-score.png",
  imageAlt: "TabShow 2.1 local Tab Chaos Score showing tab load, trend, duplicates, groups, and a quick win",
